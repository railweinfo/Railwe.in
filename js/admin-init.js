...
async function loadUsers() {
  ...
  try {
    ...
    // Requires the dedicated collection-group "list" rule in firestore.rules
    // (match /{path=**}/ndaRegister/meta) in addition to the normal
    // per-path rule — Firestore treats those as two separate permissions.
    ...
    list.innerHTML = '<p class="loading-msg">Could not load users. Check the console for details.</p>';
  }
}
